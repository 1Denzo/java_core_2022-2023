...
public class Main {
    public static void main(String[] args) throws IOException {
        ...
        String[] strings1 = bueferedReader.readLine().split(" ");
        int size2 = Integer.parseInt(bueferedReader.readLine());
        String[] strings2 = bueferedReader.readLine().split(" ");
        int size3 = Integer.parseInt(bueferedReader.readLine());
        String[] strings3 = bueferedReader.readLine().split(" ");
