...
Motobike motobike1 = new Motobike(vendor, model, age);
           ...
           motobikes.getMotobikes().stream().filter(Motobike -> { return Motobike.getAge() <=5;
            }).forEach(Motobike -> {
               System.out.println("Выборка мотоциклов возраста 5+" + motobikes.toString());
            });
    ...
    private static Document buildDocument() throws Exception {
        File file = new File("C:\\Users\\denzo\\IdeaProjects\\java_core_2022-2023\\src\\LR10\\Example1XML\\motobike.xml");
